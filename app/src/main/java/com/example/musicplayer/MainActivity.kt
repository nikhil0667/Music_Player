...
//        wakeLock.acquire()
        ...
        val powerManager = getSystemService(Context.POWER_SERVICE) as PowerManager
        wakeLock =
            powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "MusicPlayer::WakelockTag")
        ...
        searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            ...
            override fun onQueryTextChange(newText: String): Boolean {
                ...
                val filteredList = songsAdapter.getSongs().filter { song ->
                    song.title.contains(newText, ignoreCase = true) || song.artist.contains(
                        newText,
                        ignoreCase = true
                    )
                }
...
//    }
    private fun checkAudioPermission() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.RECORD_AUDIO)
            ...
            Log.d("PERMISSION", "Requesting permission...") // 🔥 Debug log
            ActivityCompat.requestPermissions(
                this,
...
//    }
    private fun setupVisualizer() {
        if (!::mediaPlayer.isInitialized || mediaPlayer.audioSessionId == 0) {
            Toast.makeText(this, "MediaPlayer not ready!", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        try {
            ...
            e.printStackTrace()
            Toast.makeText(this, "Visualizer failed to start!", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun showPermissionRationale() {
        AlertDialog.Builder(this)
            ...
            .setMessage("This app needs access to your music files. Please allow storage access in Settings.")
...
//                startActivity(intent)
//            } else {
//                loadSongs() // Load music if permission is granted
//            }
//        } else {
...
//                }
//            } else {
//                loadSongs() // Permission is already granted, load music
//            }
//        }
//    }
private fun checkStoragePermission() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_MEDIA_AUDIO)
            ...
            loadSongs() // ✅ Permission granted, load music
        }
        ...
        if (requestCode == PERMISSION_REQUEST_CODE) {
            if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                if (!shouldShowRequestPermissionRationale(permissions[0])) {
                    ...
                    Toast.makeText(this, "Permission Denied! Please grant access to media.", Toast.LENGTH_LONG).show()
                }
            }
        }
    }
